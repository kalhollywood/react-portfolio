...
- I learned about emailJS for the Contact form and was able to successfully set it up using the docs despite the tutorial not including any detailed information on this process.
...
- Logo rotation on cube took a lot of tweaking to ensure panels displayed as a cube and in the right orientation, panels were not displaying correctly originally.
